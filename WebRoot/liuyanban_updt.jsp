...
<form name="form1" id="form1" method="post" action="liuyanban_updt_post.jsp?id=<%=id %>">
    ...
    <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="#00FFFF"
        ...
        <tr>
            <td>昵称：</td>
            <td><input name='cheng' type='text' id='cheng' value='<%= cheng%>'/></td>
        </tr>
        <tr>
            <td>性别：</td>
            <td><input name='xingbie' type='text' id='xingbie' value='<%= xingbie%>'/></td>
        </tr>
        <tr>
            <td>QQ：</td>
        ...
        <tr>
            <td>内容：</td>
            <td><input name='neirong' type='text' id='neirong' value='<%= neirong%>'/></td>
        </tr>
        <tr>
            <td>&nbsp;</td>
