...
<form name="form1" id="form1" method="post" action="">
    ...
    <input type="button" name="Submit2" value="新增"
...
<table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="00FFFF"
    ...
    <tr>
        ...
        <td width="60" align="center"><a href="xinwentongzhi_updt.jsp?id=<%=id%>">修改</a> <a
...
<p align="center">&nbsp;共<%=zgs%>条记录&nbsp;&nbsp;<%=page_record %>条/页　<a href="xinwentongzhi_list.jsp?page=1&lb=<%=lb%>">首页</a>　<a
        href="xinwentongzhi_list.jsp?page=<%= curpage-1%>&lb=<%=lb%>">上一页</a>　<A
        href="xinwentongzhi_list.jsp?page=<%= curpage+1%>&lb=<%=lb%>">下一页</A>　<a
        href="xinwentongzhi_list.jsp?page=<%=zys %>&lb=<%=lb%>">尾页</A>　当前第<FONT color=red><%=curpage %>
