...
<table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="00FFFF" style="border-collapse:collapse">  
  <tr>
    ...
    <td bgcolor='#CCFFFF'>套餐名称</td><td bgcolor='#CCFFFF'>价格</td><td bgcolor='#CCFFFF'>类别</td><td bgcolor='#CCFFFF'>预订人</td><td bgcolor='#CCFFFF'>预订时间</td><td bgcolor='#CCFFFF'>备注</td><td bgcolor='#CCFFFF' width='80' align='center'>是否审核</td>
...
%>
  <tr>
    ...
    <td><%=taocanmingcheng %></td><td><%=jiage %></td><td><%=leibie %></td><td><%=yudingren %></td><td><%=yudingshijian %></td><td><%=beizhu %></td><td width='80' align='center'><%=issh%></td>
...
<p align="center">&nbsp;共<%=zgs%>条记录&nbsp;&nbsp;<%=page_record %>条/页　<a href="yudingjilu_list2.jsp?page=1">首页</a>　<a href="yudingjilu_list2.jsp?page=<%= curpage-1%>">上一页</a>　<A href="yudingjilu_list2.jsp?page=<%= curpage+1%>">下一页</A>　<a href="yudingjilu_list2.jsp?page=<%=zys %>">尾页</A>　当前第<FONT color=red><%=curpage %></FONT>页/共<FONT color=red><%=zys %></FONT>页</p>
  </body>
</html>
