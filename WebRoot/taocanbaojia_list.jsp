...
<form name="form1" id="form1" method="post" action="">
    搜索:&nbsp;&nbsp;套餐名称：<input name="taocanmingcheng" type="text" id="taocanmingcheng"
                               style='border:solid 1px #000000; color:#666666' size="12"/> 类别：
...
<table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="00FFFF"
    ...
    <tr>
        ...
        <td width="90" align="center"><a href="taocanbaojia_updt.jsp?id=<%=id%>">修改</a> <a
                href="del.jsp?id=<%=id %>&tablename=taocanbaojia" onClick="return confirm('真的要删除？')">删除</a> <a
                href="taocanbaojiadetail.jsp?id=<%=id%>" target="_blank">详细</a></td>
    </tr>
    <%
        }
    %>
...
<p align="center">&nbsp;共<%=zgs%>条记录&nbsp;&nbsp;<%=page_record %>条/页　<a href="taocanbaojia_list.jsp?page=1">首页</a>　<a
        href="taocanbaojia_list.jsp?page=<%= curpage-1%>">上一页</a>　<A href="taocanbaojia_list.jsp?page=<%= curpage+1%>">下一页</A>　<a
        href="taocanbaojia_list.jsp?page=<%=zys %>">尾页</A>　当前第<FONT color=red><%=curpage %>
