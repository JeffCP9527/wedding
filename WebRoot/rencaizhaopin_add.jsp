...
<form name="form1" id="form1" method="post" action="rencaizhaopin_add_post.jsp">
    ...
    <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="#00FFFF"
        ...
        <tr>
            <td>岗位名称：</td>
            <td><input name='gangweimingcheng' type='text' id='gangweimingcheng' value='' size='50'
                       style='border:solid 1px #000000; color:#666666'/>&nbsp;*
            </td>
        </tr>
        <tr>
            <td>招聘人数：</td>
            <td><input name='zhaopinrenshu' type='text' id='zhaopinrenshu' value=''
                       style='border:solid 1px #000000; color:#666666'/>&nbsp;*
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td>薪资待寓：</td>
            <td><input name='xinzidaiyu' type='text' id='xinzidaiyu' value=''
