                                        ...
                                        <tr>
                                            ...
                                            <td width="674" valign="top">
                                                ...
                                                <table width="100%" border="0" align="center" cellpadding="3"
                                                       cellspacing="1" bordercolor="#00FFFF" class="newsline"
                                                       style="border-collapse:collapse">
                                                    <tr>
                                                        <td align="center" class="STYLE3"><%=taocanmingcheng%>
                                                            （价格：<%=jiage%> 类别：<%=leibie%>）
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td height="289"><%=jianjie%>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td align=center><input type=button name=Submit5 value=返回
