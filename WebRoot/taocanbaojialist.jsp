...
%>
  <tr>
    ...
    <td width="138" align="center"><a href="yudingjiluadd.jsp?id=<%=id%>" >预订</a></td>
    <td width="30" align="center"> <a href="taocanbaojiadetail.jsp?id=<%=id%>" >详细</a></td>
  </tr>
  	<%
  }
   %>
...
<p align="center">&nbsp;共<%=zgs%>条记录&nbsp;&nbsp;<%=page_record %>条/页　<a href="taocanbaojialist.jsp?page=1">首页</a>　<a href="taocanbaojialist.jsp?page=<%= curpage-1%>">上一页</a>　<A href="taocanbaojialist.jsp?page=<%= curpage+1%>">下一页</A>　<a href="taocanbaojialist.jsp?page=<%=zys %>">尾页</A>　当前第<FONT color=red><%=curpage %></FONT>页/共<FONT color=red><%=zys %></FONT>页</p>
