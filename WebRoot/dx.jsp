...
<form name="form1" id="form1" method="post" action="dx_post.jsp?lb=<%=lb %>">
    ...
    <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="#00FFFF"
        ...
        <tr>
            <td>内容：</td>
            <td><textarea name="content" style="display:none"><%=contdent %></textarea>
                <iframe ID="eWebEditor1" src="eWebEditor_V4.60/ewebeditor.htm?id=content&style=coolblue" frameborder="0"
