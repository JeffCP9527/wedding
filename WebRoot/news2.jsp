                            ...
                            <tr>
                                <td width="701" height="43" background="qtimages/3_01.gif">
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                            <td width="21%" align="center" class="STYLE5"><%=lb%>
                                            </td>
                                            <td width="79%">&nbsp;</td>
                                        </tr>
                                    </table>
                                        ...
                                        <tr>
                                            ...
                                            <td width="674" valign="top">
                                                <table width="98%" border="0" align="center" cellpadding="3"
                                                       cellspacing="1" bordercolor="#AAE4D5"
                                                    ...
                                                    <%
                                                        ...
                                                        if (request.getParameter("keyword") == "" || request.getParameter("keyword") == null) {
                                                            ...
                                                            sql = sql + " and biaoti like '%" + new String(request.getParameter("keyword").getBytes("8859_1")) + "%'";
                                                        }
                                                    ...
                                                    <tr>
                                                        ...
                                                        %>
                                                            ...
                                                            %>
                                                            <a href='gg_detail2.jsp?id=<%=id%>'><img
                                                                    src='<%=shouyetupian %>' width=88 height=99
                                                                    border=0/></a>
                                                            <%
                                                                }
                                                            %></td>
                                                        <td width="296"><a href="gg_detail2.jsp?id=<%=id%>"><%=biaoti %>
                                                        </a></td>
                                                        <td width="83">被点击<%=dianjilv %>次</td>
                                                        <td width="81" align="center"><%=addtime.substring(0, 10) %>
                                                        </td>
                                                    </tr>
                                                    <%
                                                        }
                                                ...
                                                <p align="center">&nbsp;共<%=zgs%>条记录&nbsp;&nbsp;<%=page_record %>条/页　<a
                                                        href="news2.jsp?page=1&lb=<%=lb%>">首页</a>　<a
                                                        href="news2.jsp?page=<%= curpage-1%>&lb=<%=lb%>">上一页</a>　<A
                                                        href="news2.jsp?page=<%= curpage+1%>&lb=<%=lb%>">下一页</A>　<a
                                                        href="news2.jsp?page=<%=zys %>&lb=<%=lb%>">尾页</A>　当前第<FONT
                                                        color=red><%=curpage %>
