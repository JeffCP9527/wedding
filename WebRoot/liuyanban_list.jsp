...
<table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="#00FFFF"
    ...
    <tr>
        ...
        <td width="4%" bgcolor='#A4B6D7'>性别</td>
        <td width="10%" bgcolor='#A4B6D7'>QQ</td>
        <td width="11%" bgcolor='#A4B6D7'>邮箱</td>
        <td width="16%" bgcolor='#A4B6D7'>电话</td>
    ...
    <tr>
        ...
        <td><a href="del.jsp?id=<%=id %>&tablename=liuyanban" onClick="return confirm('真的要删除？')">删除</a> <a
                href="hf.jsp?id=<%=id%>">回复</a></td>
    </tr>
    <%
        }
    %>
