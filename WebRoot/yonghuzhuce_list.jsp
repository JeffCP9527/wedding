...
<table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="00FFFF" style="border-collapse:collapse">  
  <tr>
    ...
    <td bgcolor='#CCFFFF'>用户名</td><td bgcolor='#CCFFFF'>密码</td><td bgcolor='#CCFFFF'>姓名</td><td bgcolor='#CCFFFF'>性别</td><td bgcolor='#CCFFFF'>出生年月</td><td bgcolor='#CCFFFF'>QQ</td><td bgcolor='#CCFFFF'>邮箱</td><td bgcolor='#CCFFFF'>电话</td><td bgcolor='#CCFFFF'>身份证</td><td bgcolor='#CCFFFF'>头像</td><td bgcolor='#CCFFFF'>地址</td>
    <td bgcolor='#CCFFFF'>审核</td>
...
%>
  <tr>
    ...
    <td><%=yonghuming %></td><td><%=mima %></td><td><%=xingming %></td><td><%=xingbie %></td><td><%=chushengnianyue %></td><td><%=QQ %></td><td><%=youxiang %></td><td><%=dianhua %></td><td><%=shenfenzheng %></td><td><a href='<%=touxiang %>' target='_blank'><img src='<%=touxiang %>' width=88 height=99 border=0 /></a></td><td><%=dizhi %></td>
    <td><a href="sh.jsp?id=<%=id%>&tablename=yonghuzhuce&yuan=<%=issh%>"><%=issh %></a></td>
    <td><%=beizhu %></td>
    <td width="138" align="center"><%=addtime %></td>
    <td width="90" align="center"><a href="yonghuzhuce_updt.jsp?id=<%=id%>">修改</a>  <a href="del.jsp?id=<%=id %>&tablename=yonghuzhuce" onClick="return confirm('真的要删除？')">删除</a> <a href="yonghuzhuce_detail.jsp?id=<%=id%>" target="_blank">详细</a></td>
  </tr>
  	<%
  }
   %>
