...
<form name="form1" id="form1" method="post" action="yonghuzhuce_add_post.jsp">
    ...
    <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="#00FFFF"
        ...
        <tr>
            <td>用户名：</td>
            <td><input name='yonghuming' type='text' id='yonghuming' value=''/>&nbsp;*</td>
        </tr>
        <tr>
            <td>密码：</td>
        ...
        <tr>
            <td>出生年月：</td>
            <td><input name='chushengnianyue' type='text' id='chushengnianyue' value='' readonly='readonly'
        ...
        <tr>
            <td>头像：</td>
            <td><input name='touxiang' type='text' id='touxiang' size='50' value=''/>&nbsp;<input type='button'
                                                                                                  value='上传'
                                                                                                  onClick="up('touxiang')"/>
            </td>
        </tr>
