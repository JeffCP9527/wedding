...
String taocanmingcheng=request.getParameter("taocanmingcheng");String jiage=request.getParameter("jiage");String leibie=request.getParameter("leibie");String yudingren=request.getParameter("yudingren");String yudingshijian=request.getParameter("yudingshijian");String beizhu=request.getParameter("beizhu");
