...
<table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="#00FFFF"
    ...
    <tr>
        <td width='11%'>身份证：</td>
        <td width='39%'><%=shenfenzheng%>
        </td>
        <td width='11%'>头像：</td>
        <td width='39%'><%=touxiang%>
        </td>
    </tr>
    <tr>
        <td width='11%'>地址：</td>
    ...
    <tr>
        <td colspan="4" align="center"><input type="button" name="Submit" value="返回"
